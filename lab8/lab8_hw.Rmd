...
**The data is tidy as everything seems to be organized in columns and rows according to categories.The data is in long format as the sites are repeated based on the observation date**
