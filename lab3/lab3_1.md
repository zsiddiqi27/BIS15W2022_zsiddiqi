...
```r
hsprings <- data_frame(name, spring, temp_C)
```
...
```
## [1] "Jill"  "Susan" "Steve" "Jill"  "Susan" "Steve" "Jill"  "Susan" "Steve"
```


```r
hsprings <- data_frame(scientist, spring, temp_C)
hsprings
```
...
```r
hsprings <- data_frame(scientist, spring, temp_C, depth_ft)
hsprings
```
...
##   <chr>     <chr>       <dbl>    <dbl>
## 1 Jill      Buckeye      36.2     4.15
## 2 Susan     Buckeye      35.4     4.13
## 3 Steve     Buckeye      35.3     4.12
## 4 Jill      Benton       35.2     3.21
## 5 Susan     Benton       35.4     3.23
## 6 Steve     Benton       33.4     3.2 
## 7 Jill      Travertine   30.7     5.67
## 8 Susan     Travertine   29.6     5.65
## 9 Steve     Travertine   29.2     5.66
```
